...
for pdf in glob.glob(os.path.join(pdf_folder, "*.pdf")):
    ...
    for i in np.arange(1.0,2.1,0.25):
        ...
        # cv2.imshow("img.jpg",preprocessed_image)
        # cv2.waitKey(0)
        # print("Scanning")
    ...
    if so_number == "" and so_number_list[0]:
        ...
        so_confidence = so_number_list[1][max_index]
    ...
    if address == "" and address_list[0]:
        ...
        address_confidence = address_list[1][max_index]
        # print("Max conf: ", address_list)

    if address_confidence < 90:
        print("Address: ", address, " --- ", address_confidence)
    if so_confidence < 80:
        print("SO: ", so_number, " --- ", so_confidence)

    # print("Address: ", address, " --- ", address_confidence, "\nSO: ", so_number, " --- ", so_confidence)
